    ...
    if (mainPage) {
        ...
        if (!standartPage) {
            Pages.insert({
                ...
                pageContent: '<h1>Если вы&nbsp;видите эту страницу&nbsp;&mdash; значит проект еще только был развернут и&nbsp;находится в&nbsp;стадии заполнения.</h1> <div>Нельзя быть точно уверенным, в&nbsp;какой момент проект будет заполнен на&nbsp;100%, так что запаситесь терпением.</div> <div>Если&nbsp;же вы&nbsp;&mdash; владелец этого проекта, настоятельно рекомендуем заполнить его как можно быстрее, чтобы ваши посетители никогда не&nbsp;увидели эту страницу.</div> <div>С&nbsp;уважением, разработчики MBAP.</div>',
                label: 'standart'
            })
